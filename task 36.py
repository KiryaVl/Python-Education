...
def print_operation_table(num_columns):
    for i in range(1,num_columns + 1):
        print (' '.join(str(i*v) for v in range(1,num_columns + 1)))

num_columns = int(input("Введите размерность таблицы: "))

print_operation_table(num_columns)